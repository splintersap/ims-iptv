...
public class RandomDatabaseData {
	...
	public static void fillDatabase(EntityManager em, UserTransaction utx) {
		...
		Movie movie2012 = new Movie("2012", "C:/Movies/2012.mov");
		movie2012
		...
		Movie avatar = new Movie("Avatar", "C:/Movies/Avatar.mov");
		avatar
				.setDescription("Avatar is the story of an ex-Marine who finds himself "
		...
		Movie aliceInWonderland = new Movie("Alice in Wonderland",
				"C:/Movies/Alice_in_wonderland.mov");

		aliceInWonderland
				.setDescription("Tim Burton (Edward Scissorhands, Beetlejuice)"
		...
		Movie xman = new Movie("X-Men Origins: Wolverine",
				"C:/Movies/x-man.mov");
		xman
				.setDescription("Two mutant brothers, Logan and Victor, born 200 years ago, suffer"
	...
	private static void addBroadcastToTelnet(Movie movie, EntityManager em) {
