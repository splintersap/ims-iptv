package pl.edu.agh.iptv.components;
...
public class ResizableGridLayout extends GridLayout {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	public ResizableGridLayout() {
		this(1, 0, 0, 0);
	}

	public ResizableGridLayout(int rows, int cols) {
		this(rows, cols, 0, 0);
	}

	public ResizableGridLayout(int rows, int cols, int hgap, int vgap) {
